...
public final class DollyOutShotGenerator extends AbstractDollyShotGenerator implements ShotGenerator {
    @Override
    public CameraPathPlan generate(ShotRequest request, ReplayContext context) {
        return generateDolly(request, context, false);
    }

    @Override
    public ShotValidationResult validate(ShotRequest request, ReplayContext context) {
        return validateDolly(request, context, false);
    }
}
