...
Built-ins live in a registry that also accepts validated user-defined presets (import/export under `config/cinewolf-autodirector/presets`). Templates only select generators actually present in `ShotGeneratorRegistry`.
